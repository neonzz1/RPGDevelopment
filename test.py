...
level = 1
required_score = 0
character_image_right = pygame.image.load("img/Player_Sprite_R.png")
character_image_right = pygame.transform.scale(character_image_right, (50, 50))
...
def play_level():
    ...
    character_image_left = pygame.image.load("img/Player_Sprite_L.png")
